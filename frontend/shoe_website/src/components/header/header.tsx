...
import { HeaderProps } from '../../models/interface.tsx';


const Header_comp:React.FC<HeaderProps> = (props) => {
    ...
    return (
        <>  
        {props.transparent ? (<>
            <section id='Header' style={{backgroundColor:'transparent', boxShadow:'none' , position:'absolute'}}>
                <div className="headerchildmenulink" onClick={handleactiveSlider}>
                    <FaBars />
                </div>
                <div className="headerchildone">
                    <div className="logodiv">
                        <img src="../assets/images/logo/Quickshoe_transparent.png" alt="Logoimg" className='Logoimg' />
                    </div>
                </div>
